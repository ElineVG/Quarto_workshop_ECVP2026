...
institute: "KU Leuven | ECVP 2026, Bournemouth"
date: "23 August 2026"
date-format: long
format: 
  revealjs:
    ...
    footer: "[github.com/ElineVG/Quarto_workshop_ECVP2026](https://github.com/ElineVG/Quarto_workshop_ECVP2026)"
    preview-links: true
...
- Download the [workshop materials](https://github.com/ElineVG/Quarto_workshop_ECVP2026)
...
`r fa("globe")` [elinevg.github.io/](https://elinevg.github.io/)
:::
...
- or use another editor (e.g., [Positron](https://positron.posit.co/))
...
- Your website using Quarto: [personal website (example 1)](https://silviacanelon.com/); [personal website (Eline)](https://elinevg.github.io/); [documentation website](https://quarto.org/); [other website projects](https://quarto.org/docs/gallery/#websites)
...
- Your [surveys](https://surveydown.org/) in Quarto
...
## What's next for Quarto? 

[Quarto 2.0](https://opensource.posit.co/blog/2026-04-06_whats-next-quarto-2/)
...
Some alternative collaborative tools (we did not test these out yet): 

. . .

- [QuartoReview](https://github.com/Lakens/QuartoReview): a local desktop app for editing .qmd, .Rmd, and .md files
...
- [VS Code Live Share](https://visualstudio.microsoft.com/services/live-share/): collaborate on the same codebase without the need to synchronize
